package com.route.islami_app.ui.home.fragments
...
import com.route.islami_app.ui.home.fragments.adapter.SuraNamesAdapter
import com.route.islami_app.ui.suraDetails.SuraDetailsActivity
...
//        adapter = SuraNamesAdapter(chapter_names)
...
//        recyclerView.adapter = adapter
    ...
    private fun initRecyclerView() {
        ...
        adapter.onItemClickListener = object : SuraNamesAdapter.OnItemClickListener {
            override fun onItemClick(pos: Int, name: String) {
//                Toast.makeText(requireContext(),"surat $name is selected", Toast.LENGTH_SHORT).show()
